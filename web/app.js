...
let validateFileURL;
if (typeof PDFJSDev === 'undefined' || PDFJSDev.test('GENERIC')) {
  const HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io','https://127.0.0.1:8000','127.0.0.1:8000','http://localhost:8888','http://localhost:8080','http://localhost:8000','https://localhost:8000','http://localhost','https://cs.ainfo.io:8090','http://uat-tmai.ainfo.io','http://dev-tmai.ainfo.io','https://uat-tmai.ainfo.io:8080','https://dev-tmai.ainfo.io:8080'];
